...
class PointCloudDataset(Dataset):
    ...
    #         input_pooled_indices += [pooled_indices.astype(np.int64)]
    ...
    #     li = input_points + input_neighbors_indices + input_pooled_indices + input_stack_lengths
